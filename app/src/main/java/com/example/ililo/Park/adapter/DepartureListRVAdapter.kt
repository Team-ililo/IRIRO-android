package com.example.ililo.Park.adapter
...
//class DepartureListRVAdapter (private val dataList: ArrayList<>): RecyclerView.Adapter<DepartureListRVAdapter.DataViewHolder>(){
//
